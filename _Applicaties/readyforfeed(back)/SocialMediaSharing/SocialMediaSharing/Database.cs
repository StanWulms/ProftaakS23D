...
namespace SocialMediaSharing
{
    class Database
    {
        ...
        public bool ConnectDatabase(string username, string Password, string connectieString)
        {
            try
            {
                String user = username; //gebruikersnaam van de database.
                String pw = Password; //wachtwoord van de database.

                conn.ConnectionString = connectieString; //string om verbinding te maken.
        ...
        public List<Event> GetDataCaravan(string query)
        {
            OracleCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = query;
            ...
            while (dr.Read())
            {
                Event e = new Event(dr.GetInt32(0), dr.GetInt32(1), dr.GetDateTime(2), dr.GetDateTime(3), dr.GetString(4), dr.GetInt32(5), dr.GetString(6), dr.GetString(7), dr.GetString(8), dr.GetString(9));
                events.Add(e);
            }
            dr.Close();
            cmd.Dispose();
        ...
        public List<Rating> GetDataHuurtent(string query)
        {
            OracleCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = query;
