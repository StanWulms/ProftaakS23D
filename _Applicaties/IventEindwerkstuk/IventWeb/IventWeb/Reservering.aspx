...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="tbEmail" Display="Dynamic" Enabled="False" ErrorMessage="Ongeldige Email" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="AllValidators">Ongeldig Email-adres</asp:RegularExpressionValidator>
    <br /><br />
    ...
    <asp:TextBox ID="tbBankrekening" runat="server"></asp:TextBox><br /><br />
    ...
    <asp:TextBox ID="tbAccount1" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbEmail1" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbAccount2" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbEmail2" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbAccount3" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbEmail3" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbAccount4" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbEmail4" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbAccount5" runat="server" Visible="False"></asp:TextBox>
    ...
    <asp:TextBox ID="tbEmail5" runat="server" Visible="False"></asp:TextBox>
